...
const unsigned char spriteDefinitions[] = {
    SPRITE_TYPE_HEALTH, ea, SPRITE_SIZE_8PX_8PX | SPRITE_PALETTE_1,  SPRITE_ANIMATION_NONE,  SPRITE_MOVEMENT_NONE, 1, 
    SPRITE_TYPE_REGULAR_ENEMY, 40, SPRITE_SIZE_16PX_16PX | SPRITE_PALETTE_2,  SPRITE_ANIMATION_FULL,  SPRITE_MOVEMENT_RANDOM_WANDER, 1, 
    SPRITE_TYPE_REGULAR_ENEMY, 20, SPRITE_SIZE_16PX_16PX | SPRITE_PALETTE_3,  SPRITE_ANIMATION_FULL,  SPRITE_MOVEMENT_RANDOM_WANDER, 2, 
    SPRITE_TYPE_KEY, eb, SPRITE_SIZE_8PX_8PX | SPRITE_PALETTE_2,  SPRITE_ANIMATION_NONE,  SPRITE_MOVEMENT_NONE, 0, 
    SPRITE_TYPE_INVULNERABLE_ENEMY, ca, SPRITE_SIZE_16PX_16PX | SPRITE_PALETTE_2,  SPRITE_ANIMATION_SWAP,  SPRITE_MOVEMENT_LEFT_RIGHT, -3c, 
    SPRITE_TYPE_INVULNERABLE_ENEMY, ca, SPRITE_SIZE_16PX_16PX | SPRITE_PALETTE_2,  SPRITE_ANIMATION_SWAP,  SPRITE_MOVEMENT_UP_DOWN, -3c, 
    SPRITE_TYPE_DOOR, ce, SPRITE_SIZE_16PX_16PX | SPRITE_PALETTE_2,  SPRITE_ANIMATION_NONE,  SPRITE_MOVEMENT_NONE, 0, 
    SPRITE_TYPE_LOCKED_DOOR, c8, SPRITE_SIZE_16PX_16PX | SPRITE_PALETTE_3,  SPRITE_ANIMATION_NONE,  SPRITE_MOVEMENT_NONE, 0, 
    SPRITE_TYPE_ENDGAME, e8, SPRITE_SIZE_16PX_16PX | SPRITE_PALETTE_3,  SPRITE_ANIMATION_NONE,  SPRITE_MOVEMENT_NONE, 0, 
    SPRITE_TYPE_NPC, 0, SPRITE_SIZE_16PX_16PX | SPRITE_PALETTE_3,  SPRITE_ANIMATION_NONE,  SPRITE_MOVEMENT_NONE, 1, 


};

const unsigned char spriteGroupDefinitions[] = {
