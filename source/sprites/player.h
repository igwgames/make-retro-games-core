...
#define PLAYER_MOVEMENT_STYLE RI_PLAYER_MOVEMENT_STYLE_DEF
...
#if RI_PLAYER_HITBOX_SIZE_DEF == PLAYER_HITBOX_HALF_HEIGHT
...
#define PLAYER_DAMAGE_INVULNERABILITY_TIME RI_PLAYER_INVULN_TIME_INT
...
extern unsigned char teleportDestinationPointer;
